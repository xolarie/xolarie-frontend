  ...
  return (
    <>
      <div className="flex flex-col items-center w-full py-4">
        <div className="text-[8px] rounded-3xl bg-[#F0F6FF] border-[#155DFC] border-[0.5px] font-inter p-3 flex flex-row justify-center gap-3 items-center">
        ...
        <div className=" space-x-6 mt-5 flex">
          <button className="bg-gradient-to-r from-[#225BFB] to-[#931DFA] p-2 rounded-2xl text-white flex flex-row items-center gap-2 w-32">
            <p className="text-[12px]">Start Projects </p><FaArrowRight />
          </button>
          <button className="border-black border-[0.5px] p-2 rounded-2xl flex flex-row items-center gap-2">
            <p className="text-[12px]">View Our Projects</p><FaArrowRight />
          </button>
        </div>
        <div className="flex flex-row text-center space-x-4 mt-4 font-inter">
          <div>
            <h3 className="text-[20px] text-[#553FFB]">98%</h3>
            <p className="text-[10px] text-[#323232]">Client Satisfaction</p>
          </div>
          <div>
        ...
        <div className=" pt-3 w-full">
          ...
          {HeroServices.map((item, i) => (
            <li key={i} className="flex items-center rounded-3xl border border-[#707070] p-3">
              <item.icon    size={10} className="text-white rounded-full bg-gradient-to-b from-[#2C55FB] to-[#8C21FA]" /><span className="text-[7px] ml-2">{item.name}</span>
            </li>
          ))}
          </ul>
        </div>
        <div className="mt-auto justify-center flex flex-col items-center py-4">
