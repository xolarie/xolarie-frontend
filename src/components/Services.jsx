      ...
      <div className="flex flex-col items-center justify-center w-full">
        ...
        <div className="text-center">
          ...
          <p className="text-[11px] text-[#4F4F4F] py-3">
            From concept to launch, we deliver comprehensive solutions that
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    boxShadow: `-2px 8px 10px ${service.color}55`,
                  }}
                >
                ...
                <Link
                  to="/"
                  className="text-sm mt-auto text-[#2758FB] md:text-[8px] xl:text-[10px]"
                >
                  learn more
                </Link>
                <p
