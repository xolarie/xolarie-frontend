...
const Process = () => {
  return (
    <div className="flex flex-col items-center">
      ...
      <p className="md:w-[470px] mb-12 mt-4 text-center">
        A proven 5-step process that transforms ideas into exceptional digital
        products
      </p>
        ...
        {process.map((item, i) => (
          ...
          >
            ...
            <div className="w-full h-full border rounded-2xl shadow-2xl shadow-[#48484826] p-4">
              ...
              />
              <h4 className="text-xl font-bold mt-8 h-16 lg:text-sm lg:mt-1 lg:font-semibold lg:h-12 xl:text-lg xl:h-14 2xl:mt-4">
                {item.step}
              </h4>
              <p className="text-[12px] h-20 lg:text-[8px] lg:h-8 xl:text-[10px] 2xl:text-[12px] 2xl:h-10">
                {item.description}
              </p>
              <p
                style={{ "--c": item.color }}
