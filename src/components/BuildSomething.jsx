...
const BuildSomething = () => {
  return (
    <div className="h-[543px] flex flex-col items-center border w-full rounded-3xl shadow-xl p-7 shadow-[#8B22FA33] md:w-[500px] md:px-16 md:h-[363px] ">
      <div className=" border flex flex-row gap-3 px-6 py-2 my-6 rounded-2xl bg-gradient-to-r border-[#155DFC] from-[#F0F6FF] to-[#F9F5FF] items-center justify-center md:w-[]">
        ...
        <h1 className="text-[12px] md:text-[8px]">Let’s build something amazing</h1>
      </div>
      <div className="w-full flex flex-col  items-center">
        <h1 className="text-2xl text-center w-44 md:w-full md:text-3xl">
          Ready to{" "}
        ...
        <p className="text-center text-[#4F4F4F] my-2 md:text-[12px]">
      ...
      <div className="gap-3 flex flex-col items-center ">
        ...
        <div className="flex flex-col gap-2 items-center justify-center md:flex-row md:text-[12px] md:text-nowrap">
