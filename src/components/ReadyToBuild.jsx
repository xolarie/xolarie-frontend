...
const ReadyToBuild = () => {
  return (
    <div className="md:flex md:flex-col md:items-center md:justify-center w-full">
      <div className="bg-gradient-to-br from-[#2758FB] via-[#8B21FA] to-[#FF048F] p-6 md:flex md:flex-col md:items-center md:justify-center md:p-10 w-full">
        <h1 className="text-4xl my-6 text-white text-center md:w-[60vw]">
          Ready to Build a Web Product That Performs?
        </h1>
        <p className="text-white text-center text-lg md:text-sm md:w-[55vw]">
        ...
        <div className="flex flex-col items-center justify-center my-8 gap-y-4 md:flex md:flex-row md:gap-x-4">
